...
function parseTasksMarkdown(content) {
  ...
  for (const line of lines) {
    ...
    const done = doneCell.toLowerCase().includes("[x]") || doneCell.toLowerCase() === "true" || doneCell.toLowerCase() === "done";
...
async function statusCommand() {
  ...
  for (const task of tasks) {
    ...
    const priorityFn = task.priority.toLowerCase() === "high" ? chalk.red : task.priority.toLowerCase() === "medium" ? chalk.yellow : chalk.gray;
